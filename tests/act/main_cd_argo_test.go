	...
	for _, tc := range []tc{
		// Provisioned plugins deployment
		{
			...
			expArgoInputs: map[string]string{
				...
				"slack_silent":               "false",
				"slack_mention_trigger_user": "false",
				"slack_extra_mentions":       "",
			},
		},
		{
		...
		{
			name: "provisioned plugin with slack mention trigger user explicitly disabled",
			inputs: cd.WorkflowInputs{
				TriggerArgo:                         workflow.Input(true),
				GrafanaCloudDeploymentType:          workflow.Input("provisioned"),
				Environment:                         workflow.Input("dev"),
				ArgoWorkflowSlackChannel:            workflow.Input("#some-slack-channel"),
				ArgoWorkflowSlackMentionTriggerUser: workflow.Input(false),
			},
			expArgoShouldBeTriggered: true,
			expArgoInputs: map[string]string{
				"slug":                       "simple-frontend",
		...
		{
			name: "provisioned plugin with slack mention trigger user enabled",
			inputs: cd.WorkflowInputs{
				TriggerArgo:                         workflow.Input(true),
				GrafanaCloudDeploymentType:          workflow.Input("provisioned"),
				Environment:                         workflow.Input("dev"),
				ArgoWorkflowSlackChannel:            workflow.Input("#some-slack-channel"),
				ArgoWorkflowSlackMentionTriggerUser: workflow.Input(true),
			},
			expArgoShouldBeTriggered: true,
			expArgoInputs: map[string]string{
				"slug":                       "simple-frontend",
				...
				"prod_targets_all":           "true",
				"slack_silent":               "false",
				"slack_mention_trigger_user": "true",
				"slack_extra_mentions":       "",
			},
		},
		{
			name: "provisioned plugin with slack extra mentions",
			inputs: cd.WorkflowInputs{
				TriggerArgo:                    workflow.Input(true),
				GrafanaCloudDeploymentType:     workflow.Input("provisioned"),
				Environment:                    workflow.Input("dev"),
				ArgoWorkflowSlackChannel:       workflow.Input("#some-slack-channel"),
				ArgoWorkflowSlackExtraMentions: workflow.Input("<!subteam^S02ND0RCSE7>,<@U045M4H659T>"),
			},
			expArgoShouldBeTriggered: true,
			expArgoInputs: map[string]string{
				"slug":                       "simple-frontend",
				...
				"slack_silent":               "false",
				"slack_mention_trigger_user": "false",
				"slack_extra_mentions":       "<!subteam^S02ND0RCSE7>,<@U045M4H659T>",
			},
		},
		{
			name: "provisioned plugin with extra mentions and trigger user mention disabled",
			inputs: cd.WorkflowInputs{
				TriggerArgo:                         workflow.Input(true),
				GrafanaCloudDeploymentType:          workflow.Input("provisioned"),
				Environment:                         workflow.Input("dev"),
				ArgoWorkflowSlackChannel:            workflow.Input("#some-slack-channel"),
				ArgoWorkflowSlackMentionTriggerUser: workflow.Input(false),
				ArgoWorkflowSlackExtraMentions:      workflow.Input("<@U045M4H659T>"),
			},
			expArgoShouldBeTriggered: true,
			expArgoInputs: map[string]string{
				"slug":                       "simple-frontend",
				...
				"slack_silent":               "false",
				"slack_mention_trigger_user": "false",
				"slack_extra_mentions":       "<@U045M4H659T>",
			},
		},

		{
			name: "provisioned plugin with pull request labels",
			inputs: cd.WorkflowInputs{
				TriggerArgo:                   workflow.Input(true),
				GrafanaCloudDeploymentType:    workflow.Input("provisioned"),
				Environment:                   workflow.Input("dev"),
				ArgoWorkflowSlackChannel:      workflow.Input("#some-slack-channel"),
				ArgoWorkflowPullRequestLabels: workflow.Input("label1,label2"),
			},
			expArgoShouldBeTriggered: true,
			expArgoInputs: map[string]string{
				"slug":                       "simple-frontend",
				...
				"commit":                     gitSha,
				"commit_link":                "https://github.com/grafana/plugin-ci-workflows/commit/" + gitSha,
				"pull_request_labels":        "label1,label2",
				"auto_merge_environments":    "dev+ops+prod-canary+prod",
				"auto_approve_durations":     `{"dev":0,"ops":0,"prod-canary":null,"prod":null}`,
				"prod_targets_all":           "true",
				"slack_silent":               "false",
