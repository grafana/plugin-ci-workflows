...
// WithCIOptions sets the options that are used by the underlying CI workflow.
// This can be used to customize the CI workflow that is called by the CD workflow.
